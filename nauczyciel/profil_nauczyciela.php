...
$stmt_profil->execute([$nauczyciel_id]);
$nauczyciel_data = $stmt_profil->fetch(PDO::FETCH_ASSOC);
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($imie) || empty($nazwisko) || empty($data_urodzenia) || empty($email)) {
        ...
        $result = $stmt_update->execute([$imie, $nazwisko, $data_urodzenia, $email, $nauczyciel_id]);
...
<html>
<head>
    <title>Profil Nauczyciela</title>
...
<body>
    ...
    <div class="container main-content">
        ...
        <form method="post" action="profil_nauczyciela.php">
            <div class="form-group">
                <label for="imie">Imię:</label>
                <input type="text" id="imie" name="imie" value="<?php echo htmlspecialchars($nauczyciel_data['imie'] ?? ''); ?>" required>
            </div>
            <div class="form-group">
                <label for="nazwisko">Nazwisko:</label>
                <input type="text" id="nazwisko" name="nazwisko" value="<?php echo htmlspecialchars($nauczyciel_data['nazwisko'] ?? ''); ?>" required>
            </div>
            <div class="form-group">
                <label for="data_urodzenia">Data urodzenia:</label>
                <input type="date" id="data_urodzenia" name="data_urodzenia" value="<?php echo htmlspecialchars($nauczyciel_data['data_urodzenia'] ?? ''); ?>" required>
            </div>
            <div class="form-group">
                <label for="email">Email:</label>
                <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($nauczyciel_data['email'] ?? ''); ?>" required>
            </div>
